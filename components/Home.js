...
const unsplash = new Unsplash({ accessKey: 'oDHHApev43qr2LKJ3539crA5R_NlpA79O98WzpiHRCM' });
...
const WrappedHomeScreen = connect(mapStateToProps, mapActionsToProps)(HomeScreen);
